    ...
    <section id="about" className="py-20 relative overflow-hidden bg-white">
      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="bg-white p-8 rounded-2xl h-full shadow-lg border border-gray-200">
            <h3 className="text-2xl font-bold text-gradient-accent mb-4">Professional Summary</h3>
            ...
            {highlights.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-xl shadow-sm border border-gray-200" style={{backgroundColor: '#F8F9FA'}}>
                    <item.icon size={24} style={{color: '#535C91'}} />
                  </div>
                  <div>
                    <h4 className="font-bold mb-1" style={{color: '#070F2B'}}>{item.title}</h4>
